...
getFourDaysPrice() {
    ...
    // This function gets the prices for the five days ago.
    getFiveDaysPrice() {
        // Get the date for five days ago in timestamp
        let t = moment().subtract(5, 'days').unix();
        // axios.all is used to make concurrent API requests. These requests were the functions we first created and they accept an argument of the date required.
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                let f = {
                ...
                // Set the state of fivedaysprice to the content of the object f
                this.setState({ fivedaysprice: f });
            }));
    }
   // This function gets the prices for the six days ago.
    getSixDaysPrice() {
        // Get the date for six days ago in timestamp
        let t = moment().subtract(6, 'days').unix();
        // axios.all is used to make concurrent API requests. These requests were the functions we first created and they accept an argument of the date required.
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                let f = {
                ...
                // Set the state of sixdaysprice to the content of the object f
                this.setState({ sixdaysprice: f });
            }));
    }
    // This function gets the prices for the seven days ago.
    getSevenDaysPrice() {
        // Get the date for seven days ago in timestamp
        ...
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                ...
                // Set the state of sevendaysprice to the content of the object f
                this.setState({ sevendaysprice: f });
            }));
    }
    // This function gets the prices for the five days ago.
    getEightDaysPrice() {
        // Get the date for eight days ago in timestamp
        let t = moment().subtract(5, 'days').unix();
        // axios.all is used to make concurrent API requests. These requests were the functions we first created and they accept an argument of the date required.
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                ...
                // Set the state of eightdaysprice to the content of the object f
                this.setState({ eightdaysprice: f });
            }));
    }
...
componentWillMount() {
    ...
    this.getFiveDaysPrice();
    this.getSixDaysPrice();
    this.getSevenDaysPrice();
    this.getEightDaysPrice();
}
    ...
    return (
        <div className="history--section container">
            ...
            <div className="history--section__box">
                ...
                <div className="history--section__box__inner">
                    <h4>{this.state.fivedaysprice.date}</h4>
                    <div className="columns">
                        <div className="column">
                        ...
                        <div className="column">
                            <p>1 LTC = ${this.state.fivedaysprice.ltc}</p>
                        </div>
                    </div>
                </div>
                <div className="history--section__box__inner">
                    <h4>{this.state.sixdaysprice.date}</h4>
                    <div className="columns">
                        <div className="column">
                        ...
                        <div className="column">
                            <p>1 LTC = ${this.state.sixdaysprice.ltc}</p>
                        </div>
                    </div>
                </div>
                <div className="history--section__box__inner">
                    <h4>{this.state.sevendaysprice.date}</h4>
                    <div className="columns">
                        <div className="column">
                            <p>1 BTC = ${this.state.sevendaysprice.btc}</p>
                        </div>
                        <div className="column">
                            <p>1 ETH = ${this.state.sevendaysprice.eth}</p>
                        </div>
                        <div className="column">
                            <p>1 LTC = ${this.state.sevendaysprice.ltc}</p>
                        </div>
                    </div>
                </div>
                <div className="history--section__box__inner">
                    <h4>{this.state.eightdaysprice.date}</h4>
                    <div className="columns">
                        <div className="column">
                            <p>1 BTC = ${this.state.eightdaysprice.btc}</p>
                        </div>
                        <div className="column">
                            <p>1 ETH = ${this.state.eightdaysprice.eth}</p>
                        </div>
                        <div className="column">
                            <p>1 LTC = ${this.state.eightdaysprice.ltc}</p>
                        </div>
                    </div>
                </div>
